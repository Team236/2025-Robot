...
public class RobotContainer {
  ...
  XboxController testController = new XboxController(Constants.Controller.USB_TEST_CONTROLLER);
  ...
  // private final DriveFwdAndSideAndTurn driveFwdAndSideAndTurn = new
  // DriveFwdAndSideAndTurn(s_Swerve, false, 9, 0, 0);
  ...
  // private final DriveReverse driveReverse9 = new DriveReverse(s_Swerve,
  // true,-9);
  // private final DriveSideways driveSideways675 = new DriveSideways(s_Swerve,
  // false, 6.5);
  // private final DriveSideways driveSidewaysNeg675 = new DriveSideways(s_Swerve,
  // false, -6.5);
  ...
  private final BlueL_FullRun blueRun = new BlueL_FullRun(s_Swerve, elevator, algaePivot, coralPivot, coralHold);
  ...
  // private final DriveWithPath driveWithPathLeg1 = new DriveWithPath(s_Swerve,
  // false);
  ...
  // AlgaeHold
  private final AlgaeGrab algaeGrab = new AlgaeGrab(algaeHold, Constants.AlgaeHold.HOLD_SPEED1,
      Constants.AlgaeHold.HOLD_SPEED2);
  ...
  // private final PIDAlgaePivot pidAlgaeScoreNet = new PIDAlgaePivot(algaePivot,
  // Constants.AlgaePivot.ENC_REVS_SCORE_NET);
  private final PIDAlgaePivot pidSafePosition = new PIDAlgaePivot(algaePivot,
      Constants.AlgaePivot.ENC_REVS_ELEVATOR_SAFE_POSITION);
  ...
  private final CoralGrabWithCounter coralGrabWithCounter = new CoralGrabWithCounter(coralHold,
      Constants.CoralHold.HOLD_SPEED);
  ...
  // private final CoralRelease coralReleaseL4 = new CoralRelease(coralHold,
  // Constants.CoralHold.L4_RELEASE_SPEED);
  ...
  // private final PIDCoralPivot pidCoraltoL1 = new PIDCoralPivot(coralPivot,
  // Constants.CoralPivot.ENC_REVS_LEVEL1);
  // private final PIDCoralPivot pidCoraltoL2 = new PIDCoralPivot(coralPivot,
  // Constants.CoralPivot.ENC_REVS_LEVEL2);
  // private final PIDCoralPivot pidCoraltoL3 = new PIDCoralPivot(coralPivot,
  // Constants.CoralPivot.ENC_REVS_LEVEL3);
  // private final PIDCoralPivot pidCoraltoL4 = new PIDCoralPivot(coralPivot,
  // Constants.CoralPivot.ENC_REVS_LEVEL4);
   ...
   * edu.wpi.first.wpilibj2.command.button.CommandGenericHID}'s subclasses for {@link CommandXboxController
  ...
  private void configureBindings() {
    ...
    // JoystickButton lb = new JoystickButton(driverController,
    // Constants.XboxController.LB);
    ...
    // TEST Xbox Controller USB 2 
    JoystickButton xTest = new JoystickButton(auxController, Constants.XboxController.X);
    JoystickButton aTest = new JoystickButton(auxController, Constants.XboxController.A);
    JoystickButton bTest = new JoystickButton(auxController, Constants.XboxController.B);
    JoystickButton yTest = new JoystickButton(auxController, Constants.XboxController.Y);
    JoystickButton lbTest = new JoystickButton(auxController, Constants.XboxController.LB);
    JoystickButton rbTest = new JoystickButton(auxController, Constants.XboxController.RB);
    JoystickButton lmTest = new JoystickButton(auxController, Constants.XboxController.LM);
    JoystickButton rmTest = new JoystickButton(auxController, Constants.XboxController.RM);
    JoystickButton viewTest = new JoystickButton(auxController, Constants.XboxController.VIEW);
    JoystickButton menuTest = new JoystickButton(auxController, Constants.XboxController.MENU);
    POVButton upPovTest = new POVButton(auxController, Constants.XboxController.POVXbox.UP_ANGLE);
    POVButton downPovTest = new POVButton(auxController, Constants.XboxController.POVXbox.DOWN_ANGLE);
    POVButton leftPovTest = new POVButton(auxController, Constants.XboxController.POVXbox.LEFT_ANGLE);
    POVButton rightPovTest = new POVButton(auxController, Constants.XboxController.POVXbox.RIGHT_ANGLE);
  ...
  public Command getAutonomousCommand() {
    ...
    //   // autoSwitch4.get()) { // switch 4
    //   // command = legs1and2Right;
    //   // } else if (!autoSwitch1.get() && !autoSwitch2.get() && autoSwitch3.get() &&
    //   // autoSwitch4.get()) { // switch 3 and 4
    //   // command = leg1Right;
    //   // } else if (autoSwitch1.get() && !autoSwitch2.get() && !autoSwitch3.get() &&
    //   // !autoSwitch4.get()) { // switch 1
    //   // command = blueL_FullRun;
    //   // } else if (autoSwitch1.get() && !autoSwitch2.get() && !autoSwitch3.get() &&
    //   // autoSwitch4.get()) { // switch 1 and 4
    //   // command = legs1and2Left;
    //   // } else if (autoSwitch1.get() && !autoSwitch2.get() && autoSwitch3.get() &&
    //   // autoSwitch4.get()) { // switch 1, 3, 4
    //   // command = leg1Left;
