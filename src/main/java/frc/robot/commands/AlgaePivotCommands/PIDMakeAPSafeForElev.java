...
public class PIDMakeAPSafeForElev extends Command {
  ...
  //private double revs;
  private final PIDController pidControllerSafe;
  ...
  public PIDMakeAPSafeForElev(AlgaePivot algaePivot) {
    ...
    pidControllerSafe.setSetpoint(revs);
  }

  // Called when the command is initially scheduled.
  @Override
  public void initialize() {
    pidControllerSafe.reset();
  }
  ...
  public void execute() {
    ...
    if (algaePivot.getPivotEncoder() > revs) {
    ...
    algaePivot.setAlgaePivotSpeed(pidControllerSafe.calculate(algaePivot.getPivotEncoder()));
    }
  }
