...
public class FieldCentricTargetRight extends InstantCommand {
  ...
  public void initialize() {
    ...
    if (tv == 1 && Constants.Targeting.REEF_IDS.contains(targetId)) {
      ...
      x2 -= Constants.Targeting.DIST_R_CORAL_SIDE * Math.sin(Units.degreesToRadians(angle2)) * 0.0254;
      y2 += Constants.Targeting.DIST_R_CORAL_SIDE * Math.cos(Units.degreesToRadians(angle2)) * 0.0254;
