...
public class NewNewFieldCentricTargetRight extends SequentialCommandGroup {
  /** Creates a new NewFieldCentricTargetLeft. 
  public NewNewFieldCentricTargetRight(Swerve s_Swerve) {
    ...
    System.out.println("NewFieldCentricTargetRight constructor");
     ...
     /*SmartDashboard.putNumber("Target ID", targetId);
      ...
      double x1 =  s_Swerve.getx1Right();
      double y1 = s_Swerve.gety1Right();
