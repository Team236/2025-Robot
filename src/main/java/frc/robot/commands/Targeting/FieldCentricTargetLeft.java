...
public class FieldCentricTargetLeft extends InstantCommand {
  ...
  public void initialize() {
    ...
    if (tv == 1 && Constants.Targeting.REEF_IDS.contains(targetId)) {
      ...
      x2 -= Constants.Targeting.DIST_L_CORAL_SIDE * Math.sin(Units.degreesToRadians(angle2)) * 0.0254;
      y2 += Constants.Targeting.DIST_L_CORAL_SIDE * Math.cos(Units.degreesToRadians(angle2)) * 0.0254;
