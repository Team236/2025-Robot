...
/* You should consider using the more terse Command factories API instead 
   ...
   */
  public class BlueRLeg2and3concatenated extends  SequentialCommandGroup  {
  /** Creates a new RedRLeg1. */
  public BlueRLeg2and3concatenated(Swerve s_Swerve, boolean reversed) {
    ...
    TrajectoryConfig config =
        ...
        // TODO = verify the concatenation of two trajectories maintains the mid pose2d
