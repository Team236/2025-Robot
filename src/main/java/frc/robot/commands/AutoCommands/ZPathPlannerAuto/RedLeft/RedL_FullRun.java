...
public class RedL_FullRun extends SequentialCommandGroup {
  ...
  public RedL_FullRun(Swerve s_Swerve, Elevator elevator, AlgaePivot algaePivot, CoralPivot coralPivot, CoralHold coralHold) {
    addCommands(
        ...
        new RedLLeg3(s_Swerve, false), // TODO - make false if going positive in X direction
      
      // intake the coral so that we can possibly move on to leg4
      new RedLLeg4(s_Swerve, false),    
      new L4_Score_AutoLeg1(elevator, coralHold, coralPivot, algaePivot) );
  }
}