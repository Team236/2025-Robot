...
public class AlgaeLowPickup extends SequentialCommandGroup {
  /** Creates a new Algae_Score. */
  public AlgaeLowPickup(Elevator elevator, AlgaeHold algaeHold, AlgaePivot algaePivot) {
  addCommands(
   Commands.parallel(
      new PIDToHeight(elevator, Constants.Elevator.PICK_ALGAE_1_HEIGHT),
